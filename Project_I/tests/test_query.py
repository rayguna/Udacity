...
class TestQuery(unittest.TestCase):
    ...
    @classmethod
    #make a database from neos and approaches
    def setUpClass(cls):
        cls.neos = load_neos(TEST_NEO_FILE)
        cls.approaches = load_approaches(TEST_CAD_FILE)
        cls.db = NEODatabase(cls.neos, cls.approaches)
    
    #check if the created database matches the expected database
    # this test passes automatically since no filter is applied 
